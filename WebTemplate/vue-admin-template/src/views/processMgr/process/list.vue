<template>
  <div class="app-container">
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="关 键 字">
              <el-input style="width: 95%" v-model="searchObj.keyword" placeholder="审批编号/标题/手机号码/姓名"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
    ...
    />
    <!--  定义弹出层  -->
    <el-dialog title="查看审批详情" :visible.sync="formDialogVisible" width="35%">
            <h4>{{ process.title }}</h4>
            <p>{{ process.createTime }}</p>
            <h5>状态：</h5>
            <p>
            <span class="pass" v-if="process.status === 1">审批中</span>
            <span class="pass" v-else="process.status === 1">已完成</span>  
            </p>
